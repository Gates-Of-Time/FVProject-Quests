sub EVENT_SAY {
	if ($text=~/hail/i) {
		quest::say("Yes? I don't often converse with the servants of Highkeep, but what do you want? I am a very good friend of [" . quest::saylink("Carson McCabe") . "]'s. If I wished it so, you could be sent to the dungeons to converse with the artisans of pain.");
	}
	...
	if ($text=~/princess lenya/i) {
		quest::say("What do you know of the Princess? Are you  [" . quest::saylink("working for Lady McCabe") . "] or were you sent by [" . quest::saylink("someone else") . "]?");
	}
	if ($text=~/someone else/i) {
