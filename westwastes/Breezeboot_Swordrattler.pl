...
sub EVENT_ITEM {
  #:: Match a 27264 - Huge Drake Wing, 27263 - 100' of Waterproofed Rope, and 27262 - Seaworthy Planking
  if (plugin::takeItems(27264 => 1, 27263 => 1, 27262 => 1)) {
    #:: Give a 27310 - Breezeboot's Frigid Gnasher
