...
sub EVENT_ITEM {
  #:: Match a 1783 - Giant Scalebound Tome
  if (plugin::takeItems(1783 => 1)) {
    ...
    #:: Give a 17059 - Ornate Reagent Box
    quest::summonitem(17059);
  }
  #:: Match a 1786 - Sealed Reagent Box
  elsif (plugin::takeItems(1786 => 1)) {
    ...
    #:: Give a 19469 - Spell: Porlos' Fury
