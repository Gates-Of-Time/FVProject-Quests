sub EVENT_SAY {
	if ($text=~/hail/i) {
		quest::say("Well met. $name! I am a master craftsman of both steel and [" . quest::saylink("mithril plate") . "] armors. I am also the creator of the [" . quest::saylink("woodlanders shields") . "]. light shields perfect for those who spend much time under the canopy of the All Mothers forests.");
	}
	if ($text=~/mithril plate/i) {
