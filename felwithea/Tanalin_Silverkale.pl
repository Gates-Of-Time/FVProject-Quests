sub EVENT_SAY {
	if ($text=~/hail/i) {
		quest::say("Well met. $name! I am Tanalin Silverkale, provider of the finest [" . quest::saylink("mithril ore") . "] and master craftsman of [" . quest::saylink("mithril chainmail") . "]!");
	}
	if ($text=~/mithril ore/i) {
