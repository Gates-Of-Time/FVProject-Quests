sub EVENT_SAY {
	if ($text=~/hail/i) {
		quest::say("Greetings. $Name I am Reyia Beslin of the Ashen Order.  I help to train our members and I am in charge of handing out the orange and red Sashes of Order.  Would you like to know how you can get an [" . quest::saylink("orange sash") . "]? Or maybe you think you are ready to earn the [" . quest::saylink("red sash") . "]? .");
	}
	elsif($text=~/orange sash/i) {
	...
	elsif($text=~/Sapphire of Souls/i) {
...
sub EVENT_ITEM {
	#:: Turn in for Greater Lightstone ID-10400 - Cutthroat Insignia Ring ID-1903 - Legionnaire's Bracer ID-2299 - Yellow Sash of Order ID-10131
