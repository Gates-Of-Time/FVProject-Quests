sub EVENT_SAY {
	if ($text=~/coffin/i) {
		quest::say("You're looking for a craftsman, are you? Well look no further! For I, Ping Fizzlecutter, am the best in all the lands! Or at lest this side of Freeport. So you're the one that Valeron was talking about, eh? Well, while you were off traipsing around the lands he and I discussed the details of the coffin. I require nothing less than these  [" . quest::saylink("components") . "]. Get me them and I will gladly make you a coffin any king would be proud to be buried in!");
	}
	if ($text=~/components/i) {
		quest::say("I require a diamond, a star ruby, a pearl, a [" . quest::saylink("special fire emerald") . "], a sapphire, a fire opal, and two enchanted platinum bars. Take this bag and combine the items once you have them all and bring it back to me.");
	...
	if ($text=~/repair the toupee/i) {
		quest::say("Ah!! You have a toupee to repair. It must be the [" . quest::saylink("Mane Attraction") . "]. I gave a one out and it seems to always fall to pieces. Seeing as it has a 100 season warranty and I only created it 5 seasons ago, I suppose I can do it. Do you want me to [" . quest::saylink("make the Mane Attraction") . "].");
	}
