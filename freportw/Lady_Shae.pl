...
sub EVENT_SAY {
	if ($text=~/hail/i) {
		...
		quest::say("Thank you for checking into this matter. I told the Militia, but they just ignored me. It appears the dark elves keep coming in leaving mail for [" . quest::saylink("Shintl") . "] Lowbrew. Before I tell you more could you please buy me a white wine please?");
	}
	elsif ($text=~/shintl/i) {
