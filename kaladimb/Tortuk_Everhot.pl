sub EVENT_SAY {
	if ($text=~/hail/i) {
		#:: removed "I teach experienced smiths how to work [brellium ore] and craft the finest dwarven [battle shields] and [dwarven plate]."
		quest::say("Welcome to the Everhot Forges! Home of the finest smiths in all of Kaladim!");
	}
