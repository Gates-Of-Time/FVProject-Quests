...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 20450 => 1)) { # Braided Grass Amulet
    ...
    quest::summonitem(20451); # Frayed Braided Grass Amulet
    quest::unique_spawn(15167,0,0,300,-3657,3,183); #spawn nuien
    quest::signalwith(15044,15178,0); # signal Althele, Sionae
  }
...
sub EVENT_WAYPOINT_DEPART {
  if ($move == 1) {
    quest::spawn2(15178,0,0,-1584,-3669,-18,0); # Spawn Sionae
    quest::depop();
  }
}
