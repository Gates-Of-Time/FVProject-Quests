sub EVENT_SAY {
	if ($text=~/hail/i) {
		...
		quest::say("I have need of one such as you.  I have been awaiting a message. I will need a young acolyte to [" . quest::saylink("retrieve the message") . "] for me or there are also some [" . quest::saylink("fishing duties") . "] I wish to delegate.");
	}
		...
		quest::say("I have been creating shields for the crusade.  Right now I work on the sharkskin shield for the knights.  I require two shark skins. Unfortunately, most sharks are too dangerous for the squires.  I have begun using [" . quest::saylink("reef shark") . "] skins.  Will you hunt the reef sharks?");
	}
	elsif ($text=~/reef shark/i) {
		quest::say("Reef sharks are the smallest and most docile of the sharks.  Even a young acolyte can slay one.  I have heard there are some in the Ocean of Tears.  I need a young acolyte to [" . quest::saylink("hunt") . "] reef sharks.  I require their skins.?");
	}
	elsif ($text=~/hunt/i) {
