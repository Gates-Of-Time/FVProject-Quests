sub EVENT_SAY {
	if ($text=~/hail/i) {
		quest::say("It is good to see you. $name!! Do not forget that the clerics of Mithaniel Marr are here to help those who pay tribute to Him. Should you require me to [" . quest::saylink("cure disease") . "]. just mention it.");
	}
