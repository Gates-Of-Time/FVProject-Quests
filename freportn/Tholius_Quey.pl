sub EVENT_SAY {
	if ($text=~/hail/i) {
		quest::say("Welcome $name! This is the Temple of Marr and you must be another seeker of passion and valor. That is good. Become one with us and help us to defeat the [" . quest::saylink("fallen knight") . "]. It is he who has caused the demise of this city.");
	}
	elsif ($text=~/fallen knight/i) {
		quest::say("The fallen knight I speak of is none other than Sir Lucan D'Lere. The self proclaimed ruler of this city. He is no ruler and he never was no true Knight of Truth. If it were not for the [" . quest::saylink("Crusade of Tears") . "] this city would still be united in valor.");
	}
...
sub EVENT_ITEM {
	#:: Turn in for 18735 - A Tattered Note
