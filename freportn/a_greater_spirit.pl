sub EVENT_SPAWN {
	#:: Create a timer 'depop' that triggers every 1800 seconds (30 min)
	quest::settimer("depop",0);
}
...
sub EVENT_SAY {
	...
	elsif($text=~/wisps of consciousness/i) {
	...
	elsif($text=~/i will walk the path/i) {
