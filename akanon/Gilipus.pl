...
#  }
#  elsif (plugin::check_handin(\%itemcount, 55562 => 1,55555 => 1)) { # Worker's Badge - number three and Gilipus's Reading Glasses
...
#  }
#  elsif (plugin::check_handin(\%itemcount, 55563 => 1,12418 => 1)) { # Worker's badge - number four and Rubbing Alcohol
