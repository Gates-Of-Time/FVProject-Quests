...
sub EVENT_ITEM {
#::  GoD content
#::	if (plugin::takeItems(55557 => 1,55561 => 1)) { # Note to Gilipus and Worker's Badge - number 2
...
#::	}
#::	elsif (plugin::takeItems(55562 => 1,55555 => 1)) { # Worker's Badge - number three and Gilipus's Reading Glasses
...
#::	}
#::	elsif (plugin::takeItems(55563 => 1,12418 => 1)) { # Worker's badge - number four and Rubbing Alcohol
