...
sub EVENT_SAY {
	if ($text=~/hail/i) {
		...
		$npc->MoveTo(-771, 1210, -25.50, 341, 1);
		...
		$npc->MoveTo(-739, 1239, -25.5, 164, 1);
		...
		$npc->MoveTo(-471, 957, -28.50, 241, 1);
		...
		$npc->MoveTo(-845, 1299, -29.50, 126, 1);
