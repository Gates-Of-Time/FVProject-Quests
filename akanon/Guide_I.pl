...
sub EVENT_SAY {
	if ($text=~/hail/i) {
		...
		$npc->MoveTo(-771, 1210, -25.50, 341, 0);
		...
		$npc->MoveTo(-739, 1239, -25.5, 164, 0);
		...
		$npc->MoveTo(-471, 957, -28.50, 241, 0);
		...
		$npc->MoveTo(-845, 1299, -29.50, 126, 0);
