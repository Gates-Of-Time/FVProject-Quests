sub EVENT_SAY {
	if ($text=~/hail/i) {
		quest::say("Eh!!? What do I see before me? A young upstart? Some child pretending to be a great mind? If you wish to test your mettle then you will assist Tergon. Will you [" . quest::saylink("Help Tergon") . "] or are you far [" . quest::saylink("too superior") . "] to deal with such things?");
	}
		...
		quest::say("Not all experience is gained upon the battlefield. We magicians must heighten our minds to become formidable opponents. I see much promise in you, $name. I will require you to [" . quest::saylink("travel abroad") . "] toward Freeport.");
	}
	...
	#if ($text=~/defector/i) {
		#quest::say("It seems a gnome magician by the name of Toko Binlittle has gone and left the guild. He joined forces with the [" . quest::saylink("Pirates of Gunthak") . "]. Find him. He must be destroyed. Our secrets cannot be known. Return his head to me and I shall give you the [" . quest::saylink("Elemental Grimoire") . "]");
