sub EVENT_SAY { 
	if ($text=~/Hail/i) {
		quest::say("Me got da toughest weapons in da lands! Yoo come ta buy weapon or ta learn from Varrok bout [" . quest::saylink("war mace") . "] an [" . quest::saylink("war hammer") . "]?");
	}
	if ($text=~/war mace/i) {
