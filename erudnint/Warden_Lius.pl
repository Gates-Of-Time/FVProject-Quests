sub EVENT_SAY {
	if ($text=~/hail/i) {
		quest::say("Hail, citizen! This is no place for you. Make sure you keep it that way. We do not need any more [" . quest::saylink("hollow men") . "].");
	}
