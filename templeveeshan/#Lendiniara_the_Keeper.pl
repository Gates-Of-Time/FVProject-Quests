...
sub EVENT_ITEM {
  #:: Match if faction is Ally
  if ($faction == 1) {
    #:: Match a 31262 - Black Tear, a 31261 - White Tear, a 31263 - Runed Tear, and a 31260 - Glowing Drake Orb
    if (plugin::takeItems(31262 => 1, 31261 => 1, 31263 => 1, 31260 => 1)) {
      #:: Give a 31463 - Mask of the Silver Eyes
    ...
    #:: Match a 31267 - Flame Kissed Tear, a 31266 - Poison Tear, a 31265 - Serrated Tear, and a 31264 - Silver Tear
    elsif (plugin::takeItems(31267 => 1, 31266 => 1, 31265 => 1, 31264 => 1)) {
      #:: Give a 31464 - Silver Mask of the Slayer
    ...
    #:: Match a 31259 - Ruby Symbol, a 31270 - Ruby Tear, a 31253 - Silver Symbol, and a 31250 - White Symbol
    elsif (plugin::takeItems(31259 => 1, 31270 => 1, 31253 => 1, 31250 => 1)) {
      #:: Give a 31460 - Silver Charm of Tranquility
    ...
    #:: Match a 31251 - Black Symbol, a 31269 - Platinum Tear, a 31252 - Runed Symbol, and a 31254 - Serrated Symbol
    elsif (plugin::takeItems(31251 => 1, 31269 => 1, 31252 => 1, 31254 => 1)) {
      #:: Give a 31461 - Silver Bracelet of Speed
    ...
    #:: Match a 31257 - Emerald Symbol, a 31268 - Emerald Tear, a 31256 - Flame Kissed Symbol, and a 31255 - Poison Symbol
    elsif (plugin::takeItems(31257 => 1, 31268 => 1, 31256 => 1, 31255 => 1)) {
      #:: Give a 31462 - Buckler of Insight
    ...
    #:: Match a 69333 - Note from Xygoz
    elsif (plugin::takeItems(69333 => 1)) {
      ...
      #:: Give a 69334 - Lendiniara's Trinket
