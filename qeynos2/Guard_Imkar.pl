...
sub EVENT_SAY {
	if ($text=~/hail/i) {
		quest::say("Hello, $name.  My name is Imkar and I am kind of new at this job but I can give you some advice.  Be careful here in Qeynos.  There are many [" . quest::saylink("dark forces") . "] at work here that are best left undisturbed.");
	}
