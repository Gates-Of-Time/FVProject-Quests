sub EVENT_SAY {
  ...
  elsif ($text =~ /mercenary captains/i) {
  ...
  elsif ($text =~ /notorious mercenaries/i) {
...
sub EVENT_ITEM {
  #:: Match three 11990 - Kromzek Mercenary Brooch
  if (plugin::takeItems(11990 => 3)) {
    ...
    quest::exp(1000);
    #:: Give a 12555 - Potion of Draconic Rage
    quest::summonitem(12555);
  }
  #:: Match a 11991 - Captain Glarg's Brooch, a 11993 - Captain Mc'Hersh's Brooch, and a 11992 - Captain Ulmog's Brooch
  elsif (plugin::takeItems(11991 => 1, 11993 => 1, 11992 => 1)) {
    ...
    #:: Grant a small amount of experience
    quest::exp(1500);
    #:: Give a 12556 - Draconic Girdle
    quest::summonitem(12556);
  }
  #:: Match a 11995 - Grenth Drakebane's Head, a 11994 - Julius Oresco's Head, a 11997 - Rontar O'Karn's Head, and a 11996 - Sadeem Oujva's Head
  elsif (plugin::takeItems(11995 => 1, 11994 => 1, 11997 => 1, 11996 => 1)) {
    ...
    quest::exp(2000);
    #:: Give a 12557 - Draconic Pauldrons
