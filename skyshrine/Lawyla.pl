...
sub EVENT_ITEM {
  #:: Match a 1897 - Head of a Kromzek Spy, a 1898 - Teachings of Relinar, and a 1899 - Scale of Hsagra
  if (plugin::takeItems(1897 => 1, 1898 => 1, 1899 => 1)) {
    ...
    quest::exp(1000);
    #:: Give a 19470 - Spell: Hsagra's Wrath
