sub EVENT_SAY {
  ...
  elsif ($text =~ /What Draconic Loyalist Fellowship\?/i) {
  ...
  elsif ($text =~ /What draconic artifacts\?/i) {
  ...
  elsif ($text =~ /I am interested in hunting for lost artifacts\./i) {
  ...
  elsif ($text =~ /What crystalline silk mesh/i) {
  ...
  elsif ($text =~ /What oily goo secretions\?/i) {
  ...
  elsif ($text =~ /what platinum dragon scale/i) {
  ...
  elsif ($text =~ /what crystal dragon eye/i) {
  ...
  elsif ($text =~ /what golden dragon claw/i) {
  ...
  elsif ($text =~ /what dragon scripture tablet/i) {
...
sub EVENT_ITEM {
  if ($faction <= 3) {
    #:: Match two 11637 - Oily Goo Secretion and a 11636 - Crystalline Silk Mesh
    if (plugin::takeItems(11637 => 2, 11636 => 1)) {
      ...
      #:: Give a 17167 - Empty Artifact Container
    ...
    #:: Match a 28057 - Sealed Box
    elsif (plugin::takeItems(28057 => 1)) {
      ...
      #:: Give a 12559 - Mask of Draconic Enhancement
