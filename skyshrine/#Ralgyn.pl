...
sub EVENT_ITEM {
	#:: Requires Ally faction and the CircletFalinkan global set to 2
	if ($faction == 1 && $CircletFalinkan == 2) {
		#:: Match a 1866 - Glanitar's Imbued Talisman
		if (plugin::takeItems(1866 => 1)) {
			...
			#:: Give a 1867 - Circlet of the Falinkan
			quest::summonitem(1867);
			#:: Set factions
