...
sub EVENT_ITEM {
  #:: Match a 9342 - Ethereal Silver Dragon Heart, a 9341 - Ethereal Storm Dragon Heart, a 9340 - Ethereal Gold Dragon Heart, and a 9339 - Ethereal Black Dragon Heart
  if (plugin::takeItems(9342 => 1, 9341 => 1, 9340 => 1, 9339 => 1)) {
    ...
    #:: Give a 30390 - Scornful's Chromatic Talisman
    quest::summonitem(30390);
  }
  #:: Match a 9331 - Opalescent Black Dragon Scale, a 9333 - Opalescent Gold Dragon Scale, a 9332 - Opalescent Storm Dragon Scale, and a 9334 - Opalescent Silver Dragon Scale
  elsif (plugin::takeItems(9331 => 1, 9333 => 1, 9332 => 1, 9334 => 1)) {
    quest::say("You cannot fathom the importance of your actions, $name. What you have accomplished cannot be claimed in truth by many and know that all sacrifices that you and those who have undoubtedly aided you have made in fulfilling this awesome feat shall not go without notice. The Crusaders of Veeshan can express neither the prominent magnitude of the honor that you have upheld in maintaining your convictions to the Claws of Veeshan.");
    #:: Give a 30389 - Ilsi's Chromatic Amulet
    quest::summonitem(30389);
  }
  #:: Match a 9298 - Tainted Wyvern Heart and a 9297 - Shimmering Phantasm Stone
  elsif (plugin::takeItems(9298 => 1, 9297 => 1)) {
    quest::say("You cannot fathom the importance of your actions, $name. What you have accomplished cannot be claimed in truth by many and know that all sacrifices that you and those who have undoubtedly aided you have made in fulfilling this awesome feat shall not go without notice. The Crusaders of Veeshan can express neither the prominent magnitude of the honor that you have upheld in maintaining your convictions to the Claws of Veeshan.");
    #:: Give a 30394 - Chromatic Veil of the Ages
    quest::summonitem(30394);
  }
  #:: Match a 9317 - Ethereal Drakeen Brain and a 9326 - Tomb Protector Stone
  elsif (plugin::takeItems(9317 => 1, 9326 => 1)) {
    quest::say("You cannot fathom the importance of your actions, $name. What you have accomplished cannot be claimed in truth by many and know that all sacrifices that you and those who have undoubtedly aided you have made in fulfilling this awesome feat shall not go without notice. The Crusaders of Veeshan can express neither the prominent magnitude of the honor that you have upheld in maintaining your convictions to the Claws of Veeshan.");
    #:: Give a 30395 - Chromatic Cloak of the Ages
