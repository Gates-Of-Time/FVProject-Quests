sub EVENT_SAY {
  ...
  elsif ($text =~ /draconic instruments/i) {
  ...
  elsif ($text =~ /cured brontotherium hide/i) {
  ...
  elsif ($text =~ /oily goo secretion/i) {
  ...
  elsif ($text =~ /kromrif spit vodka/i) {
...
sub EVENT_ITEM {
  ...
  #:: Match a 11655 - Kromrif Bones and a 11654 - Cured Brontotherium Hide
  if (plugin::takeItems(11655 => 1, 11654 => 1)) {
    $handled = 1;
    ...
    #:: Give a 12552 - Draconic Fellowship Drum
    quest::summonitem(12552);
  }
  #:: Match a 1834 - Siren Hair and a 11657 - Shellacked Brontotherium Femur
  elsif (plugin::takeItems(1834 => 1, 11657 => 1)) {
    $handled = 1;
    ...
    #:: Give a 12553 - Draconic Fellowship Lute
    quest::summonitem(12553);
  }
  #:: Match a 10036 - Black Sapphire and a 11658 - Shellacked Dragon Horn
  elsif (plugin::takeItems(10036 => 1, 11658 => 1)) {
    $handled = 1;
    ...
    #:: Give a 12554 - Draconic Fellowship Horn
