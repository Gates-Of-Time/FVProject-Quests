...
sub EVENT_SIGNAL {
	...
	if ($singasong == 1) {
		...
		#:: Send a signal to East Freeport >> Sir_Edwin_Motte (10199)
		quest::signal(10199,4);
		#:: Send a signal to East Freeport >> Imxil_Tbrow (10012)
		quest::signal(10012,4);
	}
        elsif ($singasong == 2) {
		...
		#:: Send a signal to East Freeport >> Talym_Shoontar (10182)
		quest::signal(10182,3);
	}
	elsif ($singasong == 4) { 
