sub EVENT_SAY {
	if ($text =~ /Hail/i) {
		...
		#:: Give a 17147 - Spiritual Prismatic Pack
		quest::summonitem(17147);
	}
}

sub EVENT_ITEM {
	#:: Match a 20410 - Bladesoul's Spiritual Pouch
	if (plugin::takeItems(20410 => 1)) {
		#:: Depop with spawn timer active
		quest::depop_withtimer();
		#:: Spawn a Sleeper's Tomb >> Paldar the Insane (128094), without grid or guild war, at the current location
		quest::spawn2(128094, 0, 0, $x, $y, $z, $h);
	}
