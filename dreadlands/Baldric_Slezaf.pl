...
sub EVENT_ITEM {
	#:: Match a 10073 - Maestro's Symphony Page 24 Top, a 20383 - Maestro's Symphony Page 24 Bottom, a 20377 - Maestro's Symphony Page 25 and a 20538 - Mystical Lute
	if (plugin::takeItems(20376 => 1, 20383 => 1, 20377 => 1, 20538 => 1)) {
    	...
    	#:: Give a 20542 - Singing Short Sword
