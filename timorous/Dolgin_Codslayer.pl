...
sub EVENT_ITEM {
	#:: Match a 20696 - Froglok Essence
	if (plugin::takeItems(20696 => 1)) {
		...
		#:: Give a 20696 - Froglok Essence
		quest::summonitem(20696);
		#:: Spawn one and only a Timorous Deep >> #Faydedar (96073), without grid or guildwar, at the specified coordinates
		quest::unique_spawn(96073, 0, 0, -2178, -11745, -0.63, 126);
