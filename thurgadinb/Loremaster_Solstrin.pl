sub EVENT_SAY {
  ...
  elsif ($text =~ /working with gemstones/i) {
...
sub EVENT_ITEM {
  #:: Match a 8896 - Royal Coldain Orders
  if (plugin::takeItems(8896 => 1)) {
    ...
    #:: Give a 18610 - Forge of Icewell Arms (Royal Field Plate Study)
    quest::summonitem(18610);
    #:: Give a 18611 - Forge of Icewell Arms (Precious Gem Study)
    quest::summonitem(18611);
  }
  #:: Match a 8895 - Runed Coldain Prayer Shawl (Dain approved) or a 1199 - Runed Coldain Prayer Shawl
  elsif (plugin::takeItems(8895 => 1) || plugin::takeItems(1199 => 1)) {
    ...
    #:: Give a 17651 - Empty Coldain Issue Kit
    quest::summonitem(17651);
