sub EVENT_SAY {
	if($text=~/hail/i) {
		#:: Match a 11057 - Ragebringer
		if((plugin::check_hasitem($client, 11057)) && (!defined $qglobals{Fatestealer})) {
...
sub EVENT_ITEM {
	...
	if(plugin::takeItems(28010 => 1, 28011 => 1)) {
		...
		#:: Give item 28012 - Combined Parchment
		...
		quest::faction(53,10); 		#:: + orrupt Qeynos Guards
	...
	#:: Match a 28013 - General's Pouch, a 7506 - Jagged Diamond Dagger and a 7505 - Cazic Quill
