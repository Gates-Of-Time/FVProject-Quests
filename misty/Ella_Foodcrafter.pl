...
sub EVENT_ITEM {
	if (quest::is_content_flag_enabled(Kunark_EpicsEra)) {
		#:: Match a 18959 - Earth Stained Note
		if (plugin::takeItems(18959 => 1)) {
		...
		#:: Match a 20473 - Hardened Mixture and a 20460 - Runecrested Bowl
		elsif (plugin::takeItems(20473 => 1, 20460 => 1)) {
			...
			#:: Give a 20462 - Softly Glowing Stone
		...
		#:: Match a 20468 - Warmly Glowing Stone
			...
			#:: Give a 20440 - Elaborate Scimitar
