sub EVENT_SAY {
	if ($text=~/hail/i) {
		quest::say("Greetings, $name. You have come to me searching for tasks and tasks I have. Would you judge yourself an [" . quest::saylink("experience heretic") . "] or one who has[" . quest::saylink("much to learn") . "]?");
	}
