sub EVENT_SAY {
	if ($text=~/hail/i) {
		quest::say("Hail? You should be on your knees, $name! I suffer you in my realm for the moment, but if you and yours keep on with your attempts to destroy us, this will change. Do not think for a second that my subjects will hesitate to do what I command. I have proven myself in battle time and time again, and will do what is needed in the future. Xorbb learned this the hard way, and I am ready to teach this lesson to anyone else who challenges me.");
	}
	elsif ($text=~/xorbb/i) {
