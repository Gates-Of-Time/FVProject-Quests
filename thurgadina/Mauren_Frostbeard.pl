...
sub EVENT_ITEM {
  ...
  if ($faction <= 3) {
    ...
    #:: Match three 25816 - Nephrite and a 24950 - Torn Enchanted Silk Pantaloons.
      ...
      #:: Give a 31061 - Sage's Pantaloons.
