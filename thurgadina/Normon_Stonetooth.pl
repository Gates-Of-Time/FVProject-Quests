sub EVENT_SAY {
  if ($text =~ /hail/i) {
	...
	#:: Give a 1690 - Norman's Axe.
	quest::summonitem(1690);
  }
}

sub EVENT_ITEM {
	#:: Match a 1691 - Normon's axe.
	if (plugin::takeItems(1691 => 1)) {
		...
		#:: Give a 1692 - Velium Focus.
		quest::summonitem(1692);
		#:: Set faction
