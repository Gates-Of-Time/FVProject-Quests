sub EVENT_SAY {
  if ($text =~ /hail/i) {
    ...
    #:: Give a 17102 - Preservationists Box.
...
sub EVENT_ITEM {
  #:: Match four 29125 - Frost Giant Toes.
  if (plugin::takeItems(29125 => 4)) {
    ...
    #:: Give a 1175 - Burlap Coldain Prayer Shawl.
  ...
  #:: Match a 1175 - Burlap Coldain Prayer Shawl and a 1174 - Preserved Kromrif Heads.
  elsif (plugin::takeItems(1175 => 1, 1174 => 1)) {
    ...
    #:: Give a 1176 - Cloth Coldain Prayer Shawl.
  ...
  #:: Match a 1176 - Cloth Coldain Prayer Shawl and a 1422 - Seal of Thoridain.
  elsif (plugin::takeItems(1176 => 1, 1422 => 1)) {
    ...
    #:: Give a 1177 - Woven Coldain Prayer Shawl.
  ...
  #:: Match a 1560 - Tanik's note and a 1177 - Woven Coldain Prayer Shawl.
  elsif (plugin::takeItems(1560 => 1, 1177 => 1)) {
    ...
    #:: Give a 1178 - Fur-lined Coldain Prayer Shawl.
  ...
  #:: Match a 1199 - Runed Coldain Prayer Shawl.
  elsif (plugin::takeItems(1199 => 1)) {
    ...
    #:: Give a 1199 - Runed Coldain Prayer Shawl.
