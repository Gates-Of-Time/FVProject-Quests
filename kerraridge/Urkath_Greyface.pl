sub EVENT_SAY {
	if ($text=~/Hail/i) {
		quest::say("Errr?  What you say to Urrrkath?  Ah.  Hello to you as well. furrrless type person. Would you do Urrrkath a [" . quest::saylink("favor") . "]?");
	}
	if ($text=~/favor/i) {
		quest::say("Grrreatful I am that you would think to do this for me.  I am in need of a special leaf, called a [" . quest::saylink("Sylvani Leaf") . "], if you could brrrring this to me I would rrrrreward you verrrry well.");
	}
