sub EVENT_SAY {
        if ($text=~/Hail/i) {
                quest::say("Rrrr.. catching and prrreparing fish is my specialty. Perrrhaps you could fetch for me some [" . quest::saylink("rrrare fish") . "] so that I may demonstrate my skill? Rrrr.");
        }
