sub EVENT_SAY {
	...
	if ($text=~/interested/i) {		
		quest::say("I have messages that need to go to - well, right now I have one that needs to go to Qeynos. Will you [" . quest::saylink("deliver mail to Qeynos") . "] for me?");
		}
	if ($text=~/deliver mail to Qeynos/i) {
		quest::say("Take this letter to Tralyn Marsinger in Qeynos. You can find him at the bard guild hall. I am sure he will compensate you for your troubles..");
		 quest::summonitem(18153); #A Bardic Letter (Qeynos)(*A Bardic Letter (Qeynos)) - id : 18153
		}
}
sub EVENT_ITEM {
		#:: Return unused items
