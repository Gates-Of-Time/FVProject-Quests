sub EVENT_SAY {
	if (quest::is_content_flag_enabled("Kunark_EpicsEra")) {
		...
		elsif ($text=~/i am ready for the test of the phantasm/i) {
		...
		elsif ($text=~/head of a serpent/i) {
		...
		elsif ($text=~/essence of a ghost/i) {
