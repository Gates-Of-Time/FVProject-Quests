sub EVENT_SAY {
	if ($text=~/hail/i) {
		quest::say("Hello, $name.  If you have come to seek the way of Discord in your life, then ask me about your [" . quest::saylink("Tome of Order and Discord") . "].");
	}
	if ($text=~/Tome of Order and Discord/i) {
		quest::say("The Tome of Order and Discord was penned by the seventh member of the Tribunal and has become the key to a life of Discord, in spite of the author's pitiful warnings. Do you not have one, child of Order? Would you [" . quest::saylink("like to read") . "] it?");
	}
	if ($text=~/read/i) {
