sub EVENT_ITEM {
    #:: Match a 1093 - Marching Orders.
    if (plugin::takeItems(1093 => 1)) {
        ...
        #:: Create a timer 'spawn1' that triggers every 5 seconds (5 sec).
        quest::settimer("spawn1", 5);
        #:: Depop all Eastern Wastes >> Garadain_Glacierbane (116084).
        quest::depopall(116084);
    }
...
sub EVENT_TIMER {
    if ($timer eq "spawn1") {
        #:: Stop the timer 'spawn1'.
		quest::stoptimer("spawn1");
		#:: Spawn a Eastern Wastes >> Garadain_Glacierbane (116084), without grid or guild war, at the given location.
		quest::spawn2(116084,236,0,-389.6,-2713.6,181,19);
		#:: Spawn a Eastern Wastes >> Royal_Wolven_Guard (116563), without grid or guild war, at the given location.
		...
		#:: Spawn a Eastern Wastes >> Priest_of_Brell (116541), without grid or guild war, at the given location.
		...
		#:: Spawn a Eastern Wastes >> Royal_Archer (116555), without grid or guild war, at the given location.
		...
		#:: Spawn a Eastern Wastes >> Paladin_of_Brell (116549), without grid or guild war, at the given location.
		...
		#:: Spawn a Eastern Wastes >> Ry`Gorr_Elite (116556), without grid or guild war, at the given location.
		...
		#:: Spawn a Eastern Wastes >> Kromrif_Soldier (116548), without grid or guild war, at the given location.
		...
		#:: Spawn a Eastern Wastes >> Oracle_of_Ry`Gorr (116006), without grid or guild war, at the given location.
		quest::spawn2(116006,0,0,433.3,-3593,146.3,255);
		#:: Spawn a Eastern Wastes >> #Chief_Ry`Gorr (116577), without grid or guild war, at the given location.
		quest::spawn2(116577,0,0,425.9,-3593.2,146.3,255);
		#:: Spawn a Eastern Wastes >> Firbrand_the_Black (116012), without grid or guild war, at the given location.
		quest::spawn2(116012,0,0,416.2,-3592.8,146.3,255);
		#:: Spawn a Eastern Wastes >> ringeightcoord (116575), without grid or guild war, at the given location.
