...
sub EVENT_ITEM {
	...
	#:: Match a 12967 - Bottle of Swirling Smoke, 12966 - Bottle of Swirling Smoke, 12965 - Bottle of Swirling Smoke
		...
		quest::ding();
		#:: Set factions
		quest::faction(248, 20);		#:: + Inhabitants of Firiona Vie
		quest::faction(326, 20);		#:: + Emerald Warriors
		quest::faction(312, 20);		#:: + Storm Guard
		quest::faction(441, -60);		#:: - Legion of Cabilis
		quest::faction(313, -60);		#:: - Pirates of Gunthak
