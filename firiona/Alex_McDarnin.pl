...
sub EVENT_ITEM {
	#:: Match a 19269 - Spell: Cripple, 19238 - Spell: Spirit of Scale, 19264 - Spell: Talisman of Jasinth and a 19272 - Spell: Cannibalize III
  if (plugin::takeItems(19269 => 1) || plugin::takeItems(19238 => 1) || plugin::takeItems(19264 => 1) || plugin::takeItems(19272 => 1)) {
