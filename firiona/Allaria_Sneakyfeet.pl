sub EVENT_SAY {
  ...
  if ($text=~/i am worthy/i) {
    quest::say("Very well then. Here are the plans for the weapon that is said to cut holes into the enemy without much effort. Legend has it that if the wind is blowing, your enemy will be whistling after the fight. But they won't be whistling voluntarily.");
    quest::emote("smiles");
    quest::say("Good luck to you friend.");
    #:: Give a 18347 - Rozzuts plans
