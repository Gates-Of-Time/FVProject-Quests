sub EVENT_SAY {
	...
	elsif ($text=~/troublemaking gnome/i) {
	...
	elsif ($text=~/missing research notes/i) {
	...
	elsif ($text=~/help collect the research notes/i) {
