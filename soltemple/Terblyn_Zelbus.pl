sub EVENT_SAY { 
	...
	elsif ($text=~/who is sorko talvazon/i) {
	...
	elsif ($text=~/what nifty secrets/i) {
	...
	elsif ($text=~/what vital information/i) {
	...
	elsif ($text=~/what teleportation/i) {
	...
	elsif ($text=~/what dragon circles/i) {
