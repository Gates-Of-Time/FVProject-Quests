sub EVENT_SAY {
  ...
  elsif ($text =~ /crustacean shell armor/i) {
  ...
  elsif ($text =~ /emerald dragon scale/i) {
...
sub EVENT_ITEM {
  #:: Match a 22823 - Emerald Dragon Scales, a 24874 - Ulthork Tusks, and a 21004 - Fine Plate Breastplate
  if (plugin::takeItems(22823 => 1, 24874 => 1, 21004 => 1)) {
    quest::emote("skillfully crafts the Emerald Dragon Scales into a tunic, hands it to $name, and claps enthusiastically.");
    #:: Give a 11635 - Emerald Dragonscale Tunic
  ...
  #:: Match a 22814 - Sea Dragon Scales, a 28515 - Ornately Runed Shell Necklace, and a 3509 - Fine Steel Bracer
  elsif (plugin::takeItems(22814 => 1, 28515 => 1, 3509 => 1)) {
    quest::emote("skillfully crafts the Sea Dragon Scales into a bracer, hands it to $name, and claps enthusiastically.");
    #:: Give a 11589 - Sea Dragonscale Bracer
  ...
  #:: Match two 30059 - Barracuda Liver
  elsif (plugin::takeItems(30059 => 2)) {
    quest::emote("claps enthusiastically and hands you your reward");
    #:: Give a 30060 - Bladder of Acidic Ooze
