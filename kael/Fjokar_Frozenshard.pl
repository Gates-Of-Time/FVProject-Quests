sub EVENT_SAY {
	...
	elsif ($text =~ /Iceshard Brothers/i) {
...
sub EVENT_ITEM {
	#:: Match a 1717 - Sealed Letter (Sealed Letter to Wenglawks)
	if (plugin::takeItems(1717 => 1)) {
		...
		quest::exp(1107392);
		#:: Give a 25030 - Frozen Shard
		quest::summonitem(25030);
	}
	else {
