...
sub EVENT_ITEM {
    #:: Match if faction is Ally
    if ($faction == 1) {
        #:: Match a 25117 - Bllizent's Fang
        if (plugin::takeItems(25117 => 1)) {
        ...
        #:: Match a 25116 - Head of Ekelng Thunderstone
        elsif (plugin::takeItems(25116 => 1)) {
            ...
            #:: Give a 25048 - Vambraces of Avoidance
            ...
            quest::say("I have no need of this, little one.");
        }
    }
