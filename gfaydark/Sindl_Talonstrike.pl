sub EVENT_SAY {
	if ($text=~/Hail/i) {
		quest::say("Greetings.  Is not Kelethin the most glorious city you have seen?  A part of the forest itself, it is.  The forest is our life force.  It shelters us and we feed from its vegetation.  The [" . quest::saylink("Soldiers of Tunare") . "] have [" . quest::saylink("harvesters") . "] upon the grounds at all times.  We have our hunters.");
	}
	if ($text=~/Soldiers of Tunare/i) {
