sub EVENT_SAY {
	if (quest::is_content_flag_enabled("Kunark_EpicsEra")) { 
		if($text=~/hail/i) {
			#:: Check for 20544- Scythe of the Shadowed Soul
			if((plugin::check_hasitem($client, 20544)) && !defined($qglobals{Soulwhisper})) {
...
sub EVENT_ITEM {
	if (quest::is_content_flag_enabled("Kunark_EpicsEra")) { 
		#:: Match a 20641 - Head of Sir Edwin Motte
		if(plugin::takeItems(20641 => 1)) {
			...
			#:: Give a 20642 - Symbol of the Apprentice
			quest::summonitem(20642);
			#:: Ding!
			quest::ding();
			#:: Grant a medium amount of experience
			quest::exp(5000);
		}
		#:: Match a 20647 - Symbol of Testing
		elsif(plugin::takeItems(20647 => 1)) {
			...
			#:: Spawn a lake Rathetear >> a_bone_golem (51153), without grid or guild war, at the given location
			quest::spawn2(51153,0,0,-1498.9,283.8,58.4,57.6);
		}
		#:: Match a 20653 - Prepared Reagent Box
		elsif(plugin::takeItems(20653 => 1)) {
			...
			#:: Give a 18087 - Tome of Instruction
			quest::summonitem(18087);
			#:: Ding!
			quest::ding();
			#:: Grant a medium amount of experience
			quest::exp(10000);
		}
		#:: Match a 20652 - Gkzzallk in a Box
		elsif(plugin::takeItems(20652 => 1)) {
			...
			#:: Give a 20544 - Scythe of the Shadowed Soul
		...
		#:: Match a 20612 - Piece of the Staff
		elsif(plugin::takeItems(20612 => 1)) {
			if(defined($qglobals{NecroPre}) && ($qglobals{NecroPre} == 2)) {
				...
				#:: Give a 9831 - Note to Biddliss
				quest::summonitem(9831);
				#:: Ding!
				quest::ding();
				...
				#:: Give a 20612 - Piece of the Staff
				quest::summonitem(20612);
			}
		}
		#:: Match a 21799 - Biddliss's Research Tools
		elsif(plugin::takeItems(21799 => 1)) {
			...
			#:: Give a 22691 - Drawing of Rune
			quest::summonitem(22691);
			#:: Ding!
			quest::ding();
		}
		else {
