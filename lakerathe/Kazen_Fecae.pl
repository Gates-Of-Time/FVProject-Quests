sub EVENT_SAY {
	if($text=~/hail/i) {
		#:: Verify that the player has a 20544 - Scythe of the Shadowed Soul, and that the quest global "Soulwhisper" is NOT defined
...
sub EVENT_ITEM {
	...
	#:: Match a 20647 - Symbol of Testing
		...
		#:: Spawn Lake Rathe >> a bone golem (51153) at the given coordinates (XYZ) and heading
		quest::spawn2(51153, 0, 0, -1498.9, 283.8, 58.4, 115.2);
	}
