...
sub EVENT_ITEM {
  #:: Match a 31445 - First Half of Vin`Pekir's Tome, 31446 - Second Half of Vin`Pekir's Tome, 31443 - First Half of Al`Tarlkal's Tome, and 31444 - Second Half of Al`Tarlkal's Tome
  if (plugin::takeItems(31445 => 1, 31446 => 1, 31443 => 1, 31444 => 1)) {
