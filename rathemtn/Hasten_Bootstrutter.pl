...
sub EVENT_ITEM {
	...
	if (plugin::check_handin(\%itemcount, 7100 => 1)) {
		...
		if (plugin::check_mq_handin(12268 => 1) && $tradestate == 1) {
			quest::say("Yay, you did it!");
		}
		elsif (plugin::check_mq_handin(12268 => 1) && $tradestate == 0) {
			quest::say("You still owe me the gold!");
		}
		elsif ($tradestate == 0) {
			quest::say("You still owe me the gold and the Ring!");
		}
	}
	#:: Just Ring
	if (plugin::check_handin(\%itemcount, 12268 => 1)) {
		plugin::mq_process_items(12268 => 1);
		if (plugin::check_mq_handin(7100 => 1) && $tradestate == 1) {
			quest::say("Yay, you did it! $tradestate");
		}
		elsif (plugin::check_mq_handin(7100 => 1) && $tradestate == 0) {
			quest::say("You still owe me the gold! $tradestate");
		}
		elsif ($tradestate == 0) {
			quest::say("You still owe me the gold and the Rapier! $tradestate");
		}
	...
	if (plugin::check_handin(\%itemcount, 7100 => 1, 12268 => 1)) {
		...
		if ($tradestate == 1) {
			...
			quest::say("Now just give me the gold! $tradestate");
		}
	}
	...
	if (plugin::takeItemsCoin(0,0,3250,0, 7100 => 1)) {
		...
		if (plugin::check_mq_handin(12268 => 1, 7100 => 1)) {
			...
			$tradestate = 1;
			quest::say("You still owe me a Ring! $tradestate");
		}
	}
	#:: Just gold and Ring
	if (plugin::takeItemsCoin(0,0,3250,0, 12268 => 1)) {
		...
		if (plugin::check_mq_handin(12268 => 1, 7100 => 1)) {
			...
			$tradestate = 1;
			quest::say("You still owe me a Rapier! $tradestate");
		}
	}
	...
	if (plugin::takeCoin(0,0,3250,0)) {
		if (plugin::check_mq_handin(12268 => 1, 7100 => 1)) {
			...
			$tradestate = 1;
			quest::say("You still owe me a Ring and a Rapier! $tradestate");
		}
	}
}
