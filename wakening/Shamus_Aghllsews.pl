sub EVENT_SAY {
    ...
    elsif ($text =~ /pledge friendship/i) {
...
sub EVENT_ITEM {
    #:: Match four 30220 - Kromrif Laborer Pick
    if (plugin::takeItems(30220 => 4)) {
        ...
        #:: Give a 17865 - Empty Crest Case
        quest::summonitem(17865);
        #:: Grant a medium amount of experience
        quest::exp(35000);
        #:: Set factions
        quest::faction(449, 10); #:: + Tunarean Court
    }
    #:: Match a 30222 - Kromzek Architect Blueprints
    elsif (plugin::takeItems(30222 => 1)) {
        ...
        #:: Give a 24860 - Bag of Crushed Herbs
        quest::summonitem(24860);
        #:: Give a 17862 - Empty Sulfur Collection Bag
        quest::summonitem(17862);
        #:: Grant a medium amount of experience
        quest::exp(35000);
        #:: Set factions
        quest::faction(449, 10); #:: + Tunarean Court
    }
    #:: Match a 22855 - Pile of Rubble
    elsif (plugin::takeItems(22855 => 1)) {
        ...
        #:: Give a 24865 - Crest of the Fauns
        quest::summonitem(24865);
        #:: Grant a medium amount of experience
        quest::exp(35000);
        #:: Set factions
        quest::faction(449, 10); #:: + Tunarean Court
    }
    #:: Match a 1095 - Case of Tunarean Crests
    elsif (plugin::takeItems(1095 => 1)) {
        quest::say("Thank you $name, here is your reward.  Welcome to full membership in the Tunarean Court.");
        #:: Give a 8950 - Tunarean Signet Ring
        quest::summonitem(8950);
        #:: Set factions
        quest::faction(449, 50); #:: + Tunarean Court
        #:: Grant a medium amount of experience
        quest::exp(10000);
    }
