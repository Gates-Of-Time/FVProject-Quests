sub EVENT_SAY {
    if ($text =~ /hail/i) {
    ...
    elsif ($veliumfocus == 1 && $text =~ /find what/i) {
    ...
    elsif ($veliumfocus == 1 && $text =~ /gather these stones for you/i) {
        ...
        #:: Give a 1694 - Elbaite Focus
        quest::summonitem(1694);
    }
}

sub EVENT_ITEM {
    #:: Match a 1692 - Velium Focus
    if (plugin::takeItems(1692 => 1)) {
        ...
        #:: Give a 1701 - Velium Focus
        quest::summonitem(1701);
        #:: Set factions
        quest::faction(458, 15); #:: + Geonid Collective
    }
    #:: Match a 1693 - Velium Focus
    elsif (plugin::takeItems(1693 => 1)) {
        ...
        #:: Set factions
        quest::faction(458, 15); #:: + Geonid Collective
        quest::setglobal("veliumfocus", 1, 5, "F");
    }
    #:: Match a 1694 - Elbaite Focus, a 1695 - Reddish Crystal, a 1697 - Heavy Metallic Crystal, and a 1696 - Bent Metallic Crystal
    elsif (plugin::takeItems(1694 => 1, 1695 => 1, 1697 => 1, 1696 => 1)) {
        ...
        #:: Set factions
        quest::faction(458, 15); #:: + Geonid Collective
        #:: Give a 1698 - Azurite Focus
        quest::summonitem(1698);
        #:: Spawn a The Wakening Land >> accolyte_of_Zek (119158), without grid or guild war, at the given location
        quest::spawn2(119158, 0, 0, 408.10, -690.21, -201.55, 187);
        #:: Spawn a The Wakening Land >> accolyte_of_Zek (119158), without grid or guild war, at the given location
        quest::spawn2(119158, 0, 0, -564.04, -985.80, -191.31, 187);
        #:: Spawn a The Wakening Land >> Bloodpriest_Ioukond (119164), without grid or guild war, at the given location
        quest::spawn2(119164, 0, 0, 303.02, 254.44, -201.54, 187);
        #:: Create a timer '5' that triggers every 3600 seconds (1 hr 0 min 0 sec)
        quest::settimer(5, 3600);
    }
    #:: Match a 1698 - Azurite Focus and three 1699 - Holy Symbol of Zek
    elsif (plugin::takeItems(1698 => 1, 1699 => 3)) {
        ...
        #:: Set factions
        quest::faction(458, 10); #:: + Geonid Collective
        #:: Give a 1700 - Phenocryst's Focus
        quest::summonitem(1700);
    }
