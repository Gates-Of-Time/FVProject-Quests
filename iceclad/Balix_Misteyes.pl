sub EVENT_SAY {
	...
	elsif ($text=~/dangerous creatures/i) {
...
sub EVENT_ITEM {
	#:: Match a 30055 - Skin of the Garou, and a 30032 - Bloody Cougar Bone
	if (plugin::takeItems(30055 => 1, 30032 => 1)) {
		...
		#:: Give a 30056 - Garou Bone Club
		quest::summonitem(30056);
		#:: Ding!
		quest::ding();
		#:: Set faction
		quest::faction(439, 10); 	#:: + Snowfang Gnolls
