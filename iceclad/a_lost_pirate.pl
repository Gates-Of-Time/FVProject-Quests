sub EVENT_SAY {
	...
	elsif ($text=~/i will find the parts/i) {
		quest::emote("laughs.");
...
sub EVENT_ITEM {  
	#:: Match a 30046 - Pieces of the Iceclad Map
	if (plugin::takeItems(30046 => 1)) {
    	...
    	#:: Give a 30047 - Completed Map of Iceclad
		quest::summonitem(30047);
		#:: Ding!
		quest::ding();
		#:: Grant a large amount of experience
		quest::exp(50000);
		#:: Spawn a Iceclad Ocean >> a_snow_cougar  (116008), without grid or guild war, at the given location
