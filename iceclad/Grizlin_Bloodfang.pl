...
sub EVENT_ITEM {
	#:: Match a 25193 - Runed Totem Staff, a 30050 - Whale Bone, and a 30049 - Tinkered Rope
	if (plugin::takeItems(6310 => 1, 30050 => 1, 30049 => 1)) {
		...
		#:: Give a 30052 - Rune Shafted Harpoon
		quest::summonitem(30052);
		#:: Ding!
		quest::ding();
		#:: Grant a small amount of experience
		quest::exp(1000);
		#:: Give exactly 5 copper
