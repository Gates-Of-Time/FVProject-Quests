sub EVENT_SAY {
	...
	if ($text=~/Nolusia/i) {
		quest::emote("Nolusia is a member of the Craftkeepers. She lives as a guildmaster in Erudin Palace.");
	}
}	
