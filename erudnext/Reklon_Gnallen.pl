...
sub EVENT_ITEM {
	if (quest::is_content_flag_enabled("Kunark_EpicsEra")) {
		#:: Match a 29007 - Tainted Darksteel Breastplate and a 29006 - Pure Crystal
		if (plugin::takeItems(29001 => 1, 29006 => 1)) {
			...
			#:: Give a 29004 - Gleaming Crested Breastplate
			quest::summonitem(29004);
			#:: Ding!
			quest::ding();
		}
		#:: Match a 29000 - Tainted Darksteel Sword and a 29009 - Bucket of Pure Water
		elsif (plugin::takeItems(29000 => 1, 29009 => 1)) {
			...
			#:: Give a 29003 - Gleaming Crested Sword
			quest::summonitem(29003);
			#:: Ding!
			quest::ding();
		}
		#:: Match a 29003 - Gleaming Crested Sword, a 29004 - Gleaming Crested Breastplate and a 29006 - Gleaming Crested Shield
		elsif (plugin::takeItems(29003 => 1, 29004 => 1, 29005 => 1)) {
			...
			#:: Give a 29010 - Mark of Atonement
