sub EVENT_SAY {
	if ($text=~/hail/i) {
		quest::say("Greetings, $name! Has Lanken sent you to see me? Are you a [" . quest::saylink("visitor or citizen of Erudin") . "]?");
	}
	if ($text=~/visitor or citizen of Erudin/i) {
	...
	if ($text=~/business/i) {
		quest::say("Flynn had talked Moodoro into delivering the waters to him in Qeynos. Eventually Moodoro was caught. He was sentenced to death, but a few spells from yours truly helped him escape death by replacing him with a [" . quest::saylink("doppelganger") . "].");
	}
	if ($text=~/doppelganger/i) {
		quest::say("The doppelganger's innards were pulled out its esophagus and Moodoro went to Qeynos to start a new life. Unfortunately, he found Flynn there also. Now they have started up again somehow! My guildmaster is aware of this and fears what the High Council will do to our guild when they find this out. Will you [" . quest::saylink("help") . "] me?");
	}
	if ($text=~/help/i) {
...
sub EVENT_ITEM {
	...
	if (plugin::check_handin(\%itemcount, 13123 => 1)) {
		...
		#:: Randomly choose 13122 Erud's Tonic, 5019 Rusty Long Sword, or 6017 Splintering Club
