sub EVENT_SAY {
	if (quest::is_content_flag_enabled("Kunark_EpicsEra")) { 
		if ($text=~/hail/i) {
			...
			quest::say("My teacher is Jeb Lumsed. He was last seen in the regions of the newly discovered lands. If you wish to find him that is where you must seek him out.");
		}
...
sub EVENT_ITEM {
	if (quest::is_content_flag_enabled("Kunark_EpicsEra")) { 
		#:: Match a 10600 - Mechanical Pen, a 10601 - Ink of the Dark and a 10602 - White Paper
		if(plugin::takeItems(10600 => 1, 10601 => 1, 10602 => 1)) {
			...
			#:: Give a 10603 - Staff of GabstikCopy of Notes
