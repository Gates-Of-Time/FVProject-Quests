...
sub EVENT_SAY {
	if ($text=~/hail/i) {
		quest::say("Heh? What's yer name? $name? Never heard of ya. Now quit breathin' on me and buy us some [" . quest::saylink("drinks") . "]!");
	}
	elsif ($text=~/drinks/i) {
		...
		quest::say("What? Dragon? That was a joke, ya zombie! Sheesh! I miss [" . quest::saylink("Kaladim") . "]..");
	}
	elsif ($text=~/skippy/i) {
		#:: Match if faction is Amiable or better
		if ($faction <= 4) {
			quest::say("Skippy? You mean that fish farmer? Heh heh heh. What a moron. And his brother [" . quest::saylink("Beren") . "] has the nerve to actually threaten ME!?.. Burp.. Bah. Remind me to tell [" . quest::saylink("Kane") . "] about that steaming pile of gnoll dung.");
		}
		else {
			quest::say("You had better just be.. <BURP!>.. minding your own business if you know what is good for you. Gnollbreath. We Irontoes are proud and strong bunch of dwarves from [" . quest::saylink("Kaladim") . "]. We crush weaklings like you. <BURP>");
		}
	}
	elsif ($text=~/beren/i) {
		#:: Match if faction is Amiable or better
		if ($faction <= 4) {
			quest::say("Don't even mention that weakling's name. He.. burp.. Keeps threatening me. ME! Trumpy IRONTOE!!! Peh! That useless son of a goblin had better wise up and realize that in this burg if you ain't with [" . quest::saylink("Kane") . "], you are against him. And if you are against him.. burp.. you ain't nothing but a corpse.");		
		}
		else {
			quest::say("You had better just be.. <BURP!>.. minding your own business if you know what is good for you. Gnollbreath. We Irontoes are proud and strong bunch of dwarves from [" . quest::saylink("Kaladim") . "]. We crush weaklings like you. <BURP>");
		}
			...
			#:: Match if faction is Amiable or better
		if ($faction <= 4) {
			quest::say("Ah.. burp.. that piece of cr.. eh? Oh its you.. Kane runs this burg.. or at least he will.. if [" . quest::saylink("Sragg") . "] can get his act together.");		
		}
		else {
			quest::say("You had better just be.. <BURP!>.. minding your own business if you know what is good for you. Gnollbreath. We Irontoes are proud and strong bunch of dwarves from [" . quest::saylink("Kaladim") . "]. We crush weaklings like you. <BURP>");
		}
...
sub EVENT_WAYPOINT_ARRIVE {
	...
	if ($wp == 2) {
		quest::say("Time to drain the [" . quest::saylink("dragon") . "].. if ya know what I mean.. Bwah ha ha ha.");
...
sub EVENT_SIGNAL {
	...
	if ($signal == 1) {
		quest::say("Better start learning, [" . quest::saylink("Skippy") . "].");
...
sub EVENT_ITEM {
	...
	if (plugin::takeItems(13033 => 4)) {
		quest::say("BWAH hah hah! I knew you wasn't the loser you.. <gulp>.. <gulp>.. appear to be! I will have to tell [" . quest::saylink("Kane") . "].. <burp>.. all about you. Maybe get you in the gang!");
		#:: Ding!
		quest::ding();
		#:: Set factions
