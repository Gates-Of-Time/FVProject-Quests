...
sub EVENT_SAY {
	if ($text=~/hail/i) {
		quest::say("Hail, $name!  How's the life of an adventurer treating you? If you need some extra income, you might visit Captain Tillin at the Ground of Fate.  He is recruiting volunteers to help defend the city from the gnolls to the north.");
	}
