...
sub EVENT_SAY {
	if ($text=~/hail/i) {
		quest::say("Welcome to the Temple of Thunder. We are home to paladins and clerics who follow the ways of Karana. Do you [" . quest::saylink("need guidance") . "] or are you [" . quest::saylink("already a follower of Karana") . "]?");
	}
