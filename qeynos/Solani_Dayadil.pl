sub EVENT_SAY {
	if ($text=~/hail/i) {
		quest::say("If you are a fellow merchant. I must warn you of the inevitable tax increase.  Antonius Bayle is soon to make a [" . quest::saylink("deal") . "] with the people of Surefall Glade.");
	}
	elsif ($text=~/deal/i) {
