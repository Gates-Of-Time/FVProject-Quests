...
sub EVENT_SAY {
	if ($text=~/hail/i) {
		quest::say("Good day, traveler! You look as though you are in need of [" . quest::saylink("superior armor") . "]. We here at Firepride's specialized in armor.");
	}
	elsif ($text=~/superior armor/i) {
		quest::say("Our forge skills were acquired from the armor lords of Kaladim, as were our [" . quest::saylink("drinking skills") . "].");
	}
