sub EVENT_SAY {
	if ($text=~/hail/i) {
		quest::say("Greetings, friend. My name is Joffrey. I'm trying to learn to play the flute. I'm also working on a new song I learned while I was visiting [" . quest::saylink("Kelethin") . "].");
	}
