...
sub EVENT_SAY {
  ...
  if ($text=~/electrum-bladed wakizashi/i) {
    ...
    if ($text=~/Who must be slain?/i) {
    quest::emote("Mother? Father? May you find peace at last. I shall avenge your suffering! I will grow stronger and set free the souls of the others.");
  }
  if ($text=~/mother/i) {
